...
/**
 * Sheet (drawer) — shadcn/ui sobre `@radix-ui/react-dialog` (já instalado,
 * sem dependência npm nova). Usado pelo drawer mobile da Sidebar.
 */
...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-card shadow-overlay transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
  {
    variants: {
      side: {
